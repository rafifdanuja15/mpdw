...
```
Grafik menunjukkan sebaran harga saham PT Indofood yang bersifat bimodal, dengan dua puncak utama di kisaran Rp 9.500–10.000 dan Rp 10.700–11.000. Ini menandakan harga saham sering berada pada dua rentang tersebut. Sebaran harga cukup lebar, menunjukkan adanya fluktuasi harga selama periode pengamatan.
...
aic.arima
```
Model ARIMA(1,1,1) memiliki nilai AIC ter-rendah.
...
mape_train
```
Nilai MAPE pada train sangat baik, kurang dari 10%
...
mape_test
```
Performa model ARIMA(1,1,1) sangat baik dengan nilai MAPE 6.8%, meskipun nilai MAPE meningkat di data testing, akan tetapi model kita masih cukup handal dalam melakukan peramalan.
